...
public class ClassifierTree implements Drawable, Serializable, CapabilitiesHandler, RevisionHandler {
	...
	public String graph() throws Exception {
		...
		if (m_isLeaf) {
			text.append("N" + m_id + " [label=\"" + Utils.quote(m_localModel.dumpLabel(0, m_train)) + "\" "
	...
	public StringBuffer[] toSource(String className) throws Exception {
		...
		if (m_isLeaf) {
			...
			text.append("  static double N").append(Integer.toHexString(m_localModel.hashCode()) + printID).append(
	...
	private void graphTree(StringBuffer text) throws Exception {
		...
		for (int i = 0; i < m_sons.length; i++) {
			...
			if (m_sons[i].m_isLeaf) {
				text.append("N" + m_sons[i].m_id + " [label=\"" + Utils.quote(m_localModel.dumpLabel(i, m_train)) + "\" "
						+ "shape=box style=filled ");
				if (m_train != null && m_train.numInstances() > 0) {
					text.append("data =\n" + m_sons[i].m_train + "\n");
					text.append(",\n");
	...
	public String getAttrName() {
		...
		return this.m_localModel.leftSide(this.m_train);
	}
	...
	public String getLabel() throws Exception {
		...
		//		return this.m_localModel.dumpLabel(0, m_train);
		return ((Instances) m_train).classAttribute().value(m_localModel.distribution().maxClass(0));
	}
	...
	public String getChildCondition(int childIndex) {
		return m_localModel.rightSide(childIndex, m_train);
	}
	...
	public int getCorrectCount() {
		return (int) this.m_localModel.distribution().numCorrect();
	}
	...
	public int getInCorrectCount() {
		return (int) this.m_localModel.distribution().numIncorrect();
	}
	 ...
	 * @return
	 */
	public ClassifierTree getChild(int index) {
		return this.son(index);
	}
