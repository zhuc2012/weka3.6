...
public class MultilayerPerceptron 
   ...
   * @return
   */
  public NeuralConnection[] getConnections(){
  	return this.m_neuralNodes;
  }
  ...
  public int getConnectionCount(){
  	if(this.m_neuralNodes == null){
  		return 0;
  	}
  	return this.m_neuralNodes.length;
  }
